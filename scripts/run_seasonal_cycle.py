...
Usage:
    python scripts/run_seasonal_cycle.py
    python scripts/run_seasonal_cycle.py --variables avg_2t avg_tprate avg_msl
    python scripts/run_seasonal_cycle.py --models ifs-fesom
    python scripts/run_seasonal_cycle.py --output ./my_output
"""
...
def main():
    parser = argparse.ArgumentParser(description="Seasonal cycle diagnostic")
    ...
    print("Running seasonal cycle diagnostic...")
    saved = diag.run()
